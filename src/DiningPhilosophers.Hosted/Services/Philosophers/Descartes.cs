...
{
    public class Descartes : PhilosopherHostedService
    {
        public Descartes(ITableManager tableManager,
            ...
            : base(tableManager, configOptions, strategy, acquisitionManager, metrics, "Декарт", serviceProvider)
        {
        }
    }
}